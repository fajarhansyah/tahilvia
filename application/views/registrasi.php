          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email Anda" name="username">
                  <?php echo form_error('username','<div class="text-danger small ml-2">','</div>') ?>
                </div>
                <div class="form-group">
                  <input type="phone" class="form-control form-control-user" id="exampleInputEmail" placeholder="Nomor Telfon Anda" name="no_telp">
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block" style="background-color:#5fcf80;border-color:#5fcf80;">Daftar</button>

              </form>
              <hr>
              <div class="text-center">
                <a class="small" style="color:#5fcf80;"  href="<?php echo base_url('auth/login') ?>">Sudah punya akun ? Silahkan Login!</a>
              </div>
            </div>
          </div>
        </div>
