    ...
    <li>Personal Details</li> -->
      ...
      <fieldset>
        ...
        <div class="custom-control custom-checkbox mr-sm-2" style="text-align: left;">
          <input type="checkbox" class="custom-control-input" id="customControlAutosizing" name="tidak_ada" value="Tidak ada" style="width: 10%;">
          <label class="custom-control-label" for="customControlAutosizing">Tidak Ada</label>
        </div>
        <div class="custom-control custom-checkbox mr-sm-2" style="text-align: left;">
          <input type="checkbox" class="custom-control-input" id="customControlAutosizing" name="noda_makanan" value="Noda Makanan" style="width: 10%;">
          <label class="custom-control-label" for="customControlAutosizing">Noda Makanan</label>
        </div>
        <div class="custom-control custom-checkbox mr-sm-2" style="text-align: left;">
          <input type="checkbox" class="custom-control-input" id="customControlAutosizing" name="noda_minyak" value="Noda Minyak" style="width: 10%;">
          <label class="custom-control-label" for="customControlAutosizing">Noda Minyak</label>
        </div>
        <div class="custom-control custom-checkbox mr-sm-2" style="text-align: left;">
          <input type="checkbox" class="custom-control-input" id="customControlAutosizing" name="noda_hewan" value="Noda Hewan" style="width: 10%;">
        ...
        <div class="custom-control custom-checkbox mr-sm-2" style="text-align: left;">
          ...
          <input type="text" name="nodalainya" />
        </div>
        <hr>
